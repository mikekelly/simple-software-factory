...
pub const LOGINS: &[Login] = &[
    Login {
        ...
        open_url: false,
        hint: "Claude Code starts: sign in (open the URL it prints, paste the code back), clear whatever it shows next (theme, onboarding, the bypass-permissions warning, folder trust), then /exit",
    },
    Login {
        harness: "codex",
        argv: &["codex"],
        ...
        open_url: false,
        hint: "Codex starts: pick \"Sign in with Device Code\" and enter the code on the page it names, clear whatever it shows next (folder trust, onboarding), then /quit",
    },
    Login {
        harness: "gemini",
        ...
        status: &[],
        open_url: false,
        hint: "Gemini starts: pick \"Sign in with Google\" (or an API key), open the URL it prints, paste the code back, clear whatever it shows next (folder trust), then /quit",
    },
    Login {
        harness: "copilot",
        argv: &["copilot"],
        ...
        status: &[],
        open_url: false,
        hint: "Copilot starts: type /login and enter the one-time code on the page it names, clear whatever it shows next (folder trust), then /exit",
    },
    Login {
        harness: "opencode",

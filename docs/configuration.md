...
rather than reasoning your way to an answer, say where you have not, and
apply the same to what you write about a change) and the **gauntlet**
rule: ssf runs one session per item and starts no reviewer,
